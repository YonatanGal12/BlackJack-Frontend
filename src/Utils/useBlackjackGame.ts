...
export function useBlackjackGame() 
{
    ...
    async function restartAll()
    {
        ...
        await fetch('http://localhost:3001/game/restartAll',{
            method: "PATCH"
        })
    ...
    }, [playerHand, playerScore, dealerHand, dealerScore, message, remainingCards, isFirstTurn, phase, totalMoney, currentBet]);
